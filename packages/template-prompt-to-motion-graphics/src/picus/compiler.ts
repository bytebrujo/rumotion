...
import * as PicusShapes from "@picus/shapes";
...
export function compileCode(code: string): CompilationResult {
  ...
  try {
    ...
    const Component = createComponent(
      ...
      PicusShapes.Rect,
      PicusShapes.Circle,
      PicusShapes.Triangle,
      PicusShapes.Star,
      PicusShapes.Polygon,
      PicusShapes.Ellipse,
      PicusShapes.Heart,
      PicusShapes.Pie,
      PicusShapes.makeRect,
      PicusShapes.makeCircle,
      PicusShapes.makeTriangle,
      PicusShapes.makeStar,
      PicusShapes.makePolygon,
      PicusShapes.makeEllipse,
      PicusShapes.makeHeart,
      PicusShapes.makePie,
      // Transitions
      TransitionSeries,
      linearTiming,
