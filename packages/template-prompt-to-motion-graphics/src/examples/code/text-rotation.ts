...
export const textRotationCode = `import { useCurrentFrame, AbsoluteFill, interpolate } from "picus";

export const MyAnimation = () => {
  const frame = useCurrentFrame();

  // Text content - easily customizable
  const WORDS = ["This is a", "Text rotation example", "using Picus!"];
...
export const textRotationExample: PicusExample = {
  id: "text-rotation",
  name: "Text Rotation",
