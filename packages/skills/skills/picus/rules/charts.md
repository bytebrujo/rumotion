---
name: charts
description: Chart and data visualization patterns for Picus. Use when creating bar charts, pie charts, line charts, stock graphs, or any data-driven animations.
metadata:
...
Use `@picus/paths` for animating SVG paths (line charts, stock graphs, signatures).

Install: `npx picus add @picus/paths`  
Docs: https://picus.dev/docs/paths.md
