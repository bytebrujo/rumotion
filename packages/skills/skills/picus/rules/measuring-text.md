...
# Measuring text in Picus

## Prerequisites

Install @picus/layout-utils if it is not already installed:

```bash
npx picus add @picus/layout-utils
```
...
```tsx
import { loadFont } from "@picus/google-fonts/Inter";
