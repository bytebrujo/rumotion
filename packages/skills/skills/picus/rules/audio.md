---
name: audio
description: Using audio and sound in Picus - importing, trimming, volume, speed, pitch
metadata:
  tags: audio, media, trim, volume, speed, loop, pitch, mute, sound, sfx
---

# Using audio in Picus
...
```bash
npx picus add @picus/media
```

## Importing Audio

Use `<Audio>` from `@picus/media` to add audio to your composition.
...
```tsx
<Audio src="https://picus.media/audio.mp3" />
```
