// Adjustments to the EvaluatePicusSection.tsx to separate the flex box into two boxes
...
const EvaluatePicusSection: React.FC = () => {
	...
	return (
		<div className="flex flex-col lg:flex-row gap-2">
			...
			<div className={'card flex-1 flex flex-col'}>
				<div className={'fontbrand text-2xl font-bold'}>
					Get help with your Picus project
				</div>
				<p className={'text-muted fontbrand leading-snug'}>
...
export default EvaluatePicusSection;
