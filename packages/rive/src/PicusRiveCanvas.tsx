...
import {useCurrentFrame, useDelayRender, useVideoConfig} from 'picus';
import type {
	PicusRiveCanvasAlignment,
	PicusRiveCanvasFit,
} from './map-enums.js';
...
interface RiveProps {
	readonly src: string;
	readonly fit?: PicusRiveCanvasFit;
	readonly alignment?: PicusRiveCanvasAlignment;
...
const PicusRiveCanvasForwardRefFunction: React.ForwardRefRenderFunction<
	RiveCanvasRef,
	RiveProps
> = (
	{
...
export const PicusRiveCanvas = forwardRef(
	PicusRiveCanvasForwardRefFunction,
);
