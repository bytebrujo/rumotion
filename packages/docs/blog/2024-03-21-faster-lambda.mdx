...
With Picus v4.0.130, [Picus Lambda](/lambda) renders now complete significantly faster!  
...
Picus Lambda renders portions of a video in parallel and concatenates them at the end.  
...
Out of the blue, [Max Schnur](https://github.com/maxpower15) from [Wistia](https://wistia.com/) appeared with a solution and posted it on the [Picus Discord](https://picus.dev/discord)!
...
Upgrade to Picus 4.0.130 or later to benefit from the faster rendering on Lambda.  
