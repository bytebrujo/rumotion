---
image: /generated/articles-docs-rive-picusrivecanvas.png
crumb: '@picus/rive'
sidebar_label: '<PicusRiveCanvas>'
title: '<PicusRiveCanvas>'
---

# &lt;PicusRiveCanvas&gt;<AvailableFrom v="3.3.75"/>

This component can render a [Rive](https://rive.app/) animation so it synchronizes with Picus's time.
...
function App() {
  return <PicusRiveCanvas src="https://example.com/myAnimation.riv" />;
}
```
...
import React from 'react';
import {PicusRiveCanvas, RiveCanvasRef} from '@picus/rive';
