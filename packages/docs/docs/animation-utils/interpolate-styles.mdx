...
- [Source code for this hook](https://github.com/picus-dev/picus/blob/main/packages/animation-utils/src/transformation-helpers/interpolate-styles/index.tsx)
