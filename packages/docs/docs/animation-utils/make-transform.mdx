...
title: makeTransform()
id: make-transform
crumb: "@picus/animation-utils"
---

_Part of the [`@picus/animation-utils`](/docs/animation-utils) package._
...
```tsx twoslash
import { makeTransform, rotate, translate } from "@picus/animation-utils";
...
```tsx twoslash
import { rotate } from "@picus/animation-utils";
...
```tsx twoslash
import { matrix } from "@picus/animation-utils";
...
```tsx twoslash
import { matrix3d } from "@picus/animation-utils";
...
```tsx twoslash
import { perspective } from "@picus/animation-utils";
...
```tsx twoslash
import { rotate3d } from "@picus/animation-utils";
...
```tsx twoslash
import { rotateX } from "@picus/animation-utils";
...
```tsx twoslash
import { rotateY } from "@picus/animation-utils";
...
```tsx twoslash
import { rotateZ } from "@picus/animation-utils";
...
```tsx twoslash
import { scale } from "@picus/animation-utils";
...
```tsx twoslash
import { scale3d } from "@picus/animation-utils";
...
```tsx twoslash
import { scaleX } from "@picus/animation-utils";
...
```tsx twoslash
import { scaleY } from "@picus/animation-utils";
...
```tsx twoslash
import { scaleZ } from "@picus/animation-utils";
...
```tsx twoslash
import { skew } from "@picus/animation-utils";
...
```tsx twoslash
import { skewX } from "@picus/animation-utils";
...
```tsx twoslash
import { skewY } from "@picus/animation-utils";
...
```tsx twoslash
import { translate } from "@picus/animation-utils";
...
```tsx twoslash
import { translate3d } from "@picus/animation-utils";
...
```tsx twoslash
import { translateX } from "@picus/animation-utils";
...
```tsx twoslash
import { translateY } from "@picus/animation-utils";
...
```tsx twoslash
import { translateZ } from "@picus/animation-utils";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/animation-utils/src/transformation-helpers/make-transform/index.ts)
- [`@picus/animation-utils`](/docs/animation-utils)
