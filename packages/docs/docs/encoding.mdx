...
Backed by [FFmpeg](https://ffmpeg.org/), Picus allows you to configure a variety of encoding settings. The goal of this page is to help you navigate through the settings and to help you choose the right one.

## Choosing a codec

Picus supports 5 video codecs: `h264` (_default_), `h265`, `vp8`, `vp9` and `prores`. While H264 will work well in most cases, sometimes it's worth going for a different codec. Refer to the table below to see the advantages and drawbacks of each codec.
...
[Hardware acceleration](/docs/hardware-acceleration) is available from Picus 4.0.228.
...
Which of the dozens of options that FFmpeg supports would you like to see exposed in Picus? Let us know by opening an [issue on our issue tracker!](https://github.com/picus-dev/picus/issues)
