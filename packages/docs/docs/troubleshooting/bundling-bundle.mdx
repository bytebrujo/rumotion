...
```
 ⨯ ./node_modules/@picus/bundler/node_modules/webpack/lib/FileSystemInfo.js:9:0
...
```
 ⨯ ./node_modules/@picus/compositor-darwin-arm64/picus
...
**If you are rendering on Lambda**: Create a bundle and deploy it once either via [`npx picus sites create`](/docs/lambda/cli/sites/create) or using [`deploySite()`](/docs/lambda/deploysite) in a non-bundled Node.js script and then refer to the bundle via the URL that you get back.
