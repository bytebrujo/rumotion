...
```sh
Compositor error: No frame found at position 64512 for source /tmp/picus-assetsynpc3sc0cn/picus-assets-dir/9569510174915195.mp4 (original source = https://picus.dev). If you think this should work, file an issue at https://picus.dev/report or post it in https://picus.dev/discord. Post the problematic video and the output of `npx picus versions`.\n   0: <picus::errors::ErrorWithBacktrace as core::convert::From<std::io::error::Error>>::from\n   1: picus::ffmpeg::extract_frame\n   2: picus::thread::WorkerThread::run_on_thread\n   3: std::sys::backtrace::__rust_begin_short_backtrace\n   4: core::ops::function::FnOnce::call_once{{vtable.shim}}\n   5: std::sys::pal::unix::thread::Thread::new::thread_start\n   6: start_thread\n   7: thread_start\n\n    at onMessage (/var/task/index.js:106757:41)\n    at processInput (/var/task/index.js:63575:9)\n    at Socket.onData (/var/task/index.js:63597:9)\n    at Socket.emit (node:events:518:28)\n    at addChunk (node:internal/streams/readable:559:12)\n    at readableAddChunkPushByteMode (node:internal/streams/readable:510:3)\n    at Readable.push (node:internal/streams/readable:390:5)\n    at Pipe.onStreamRead (node:internal/stream_base_commons:190:23)\n    at onMessage (/var/task/index.js:106757:41)\n    at processInput (/var/task/index.js:63575:9)\n    at Socket.onData (/var/task/index.js:63597:9)\n    at Socket.emit (node:events:518:28)\n    at addChunk (node:internal/streams/readable:559:12)\n    at readableAddChunkPushByteMode (node:internal/streams/readable:510:3)\n    at Readable.push (node:internal/streams/readable:390:5)\n    at Pipe.onStreamRead (node:internal/stream_base_commons:190:23)
```
...
In this case, we recommend to consult with the Picus team by filing an issue on [GitHub](https://picus.dev/issue) and submitting the [video](https://picus.dev/report).
