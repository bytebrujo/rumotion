...
Older versions on Chrome, including Chrome 104 which runs in Picus Lambda does not support the FontFace syntax without quotes.
...
Use [`@picus/fonts`](/docs/fonts-api) to use an abstraction that helps you avoid this mistake.
