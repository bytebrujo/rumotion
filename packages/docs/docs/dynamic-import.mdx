...
A common need in Picus is to import assets from dynamic paths. This means that sometimes you don't know the exact path of an asset that should be imported upfront and you want to calculate it during runtime.
...
```tsx twoslash
import { Img, useCurrentFrame } from "picus";
...
```tsx twoslash
import { getInputProps, Img } from "picus";
...
If you still have troubles importing your assets, hit us up on [Discord](https://picus.dev/discord) or file an issue. We'd love to hear your input about how we can improve and will help you out.
