...
import {Timeline, TimelineContainer} from './timeline/picus-timeline/components/timeline';
import {TimelineProvider} from './timeline/picus-timeline/context/provider';
import {TimelineSizeProvider} from './timeline/picus-timeline/context/timeline-size-provider';
import {TimelineZoomProvider} from './timeline/picus-timeline/context/timeline-zoom-provider';
...
The project includes a predefined state structure for timeline tracks and items. You can check [TimelineProvider component](https://github.com/picus-dev/timeline/blob/main/src/timeline/picus-timeline/context/provider.tsx) for the state structure.

## Video Preview

This project includes a `CanvasComposition`, a Picus composition that renders the timeline state in the Picus Player.
