...
We recommend that you use one of our Saas templates to setup a Picus project that has both a frontend and backend.
...
## Create Picus project files

Follow [these instructions](/docs/player-into-picus-project) for how to turn your `<Player>`-based frontend into a Picus project.  
...
In [`src/timeline/video-preview.tsx`](https://github.com/picus-dev/timeline/blob/main/src/timeline/video-preview.tsx), you can see that the timeline state is being passed to the [`<Player>`](/docs/player) component.
