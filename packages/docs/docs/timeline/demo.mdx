...
Here is a walkthrough of how to add the Picus Timeline to your project.

Timestamps:

<JumpToVideoLink>00:17</JumpToVideoLink> - Copying the Picus Timeline
