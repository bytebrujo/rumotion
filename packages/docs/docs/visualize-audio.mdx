...
Default `"accuracy"`. When set to `"speed"`, a faster Fast Fourier transform is used. Recommended for Picus Lambda and when using a high number of samples. Read [user](https://discord.com/channels/809501355504959528/1189048518988550264/1190228606287360030) [experiences](https://discord.com/channels/809501355504959528/1155110845488046111/1155111360481480725) [here](https://github.com/picus-dev/picus/issues/2925).
...
```tsx twoslash
import {useAudioData, visualizeAudio} from '@picus/media-utils';
import {Html5Audio, staticFile, useCurrentFrame, useVideoConfig} from 'picus';
...
```tsx twoslash
import {visualizeAudio} from '@picus/media-utils';
const params = {
  audioData: {
    channelWaveforms: [],
    sampleRate: 0,
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-utils/src/visualize-audio.ts)
