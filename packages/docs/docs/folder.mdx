...
- They only visually change the sidebar in the Picus Studio and have no further behavior.
...
- [Source code for this component](https://github.com/picus-dev/picus/blob/main/packages/core/src/Folder.tsx)
