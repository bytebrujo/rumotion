...
crumb: "@picus/google-fonts"
---

import {AvailableFonts} from '../../components/AvailableFonts'

_Part of the [`@picus/google-fonts`](/docs/google-fonts) package_

Array of all available fonts available in `@picus/google-fonts`.  
...
- `importName` is the identifier of how the font can be imported: `@picus/google-fonts/[import-name]`.
