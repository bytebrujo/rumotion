...
import {getInfo} from '@picus/google-fonts/InterTight';
...
import {getInfo} from '@picus/google-fonts/InterTight';
import {loadFontFromInfo} from '@picus/google-fonts/from-info';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/google-fonts/src/from-info.ts)
