...
Creates a new [Vercel Sandbox](https://vercel.com/docs/vercel-sandbox) with all Picus dependencies installed, including system libraries, the compositor, and a browser.  
After creating the sandbox, call [`addBundleToSandbox()`](/docs/vercel/add-bundle-to-sandbox) to copy your Picus bundle into it.
...
import type {CreateSandboxOnProgress} from '@picus/vercel';
// ---cut---
...
// @module: es2022
// @target: es2022
import {createSandbox} from '@picus/vercel';
// ---cut---
const sandbox = await createSandbox({
  resources: {vcpus: 8},
});
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/vercel/src/create-sandbox.ts)
