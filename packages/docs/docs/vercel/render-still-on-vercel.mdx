...
// @module: es2022
// @target: es2022
import {renderStillOnVercel, addBundleToSandbox, createSandbox} from '@picus/vercel';
...
An object containing key-value pairs of environment variables which will be injected into your Picus project and which can be accessed by reading the global `process.env` object. Default: `{}`.
...
_function_ <TsType type="RenderStillOnVercelProgress" source="@picus/vercel" href="/docs/vercel/types#renderstillonvercelprogress" />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/vercel/src/render-still-on-vercel.ts)
