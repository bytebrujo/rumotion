...
// @module: es2022
// @target: es2022
import {uploadToVercelBlob, addBundleToSandbox, createSandbox} from '@picus/vercel';
...
<TsType type="VercelBlobAccess" source="@picus/vercel" href="/docs/vercel/types#vercelblobaccess" />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/vercel/src/upload-to-vercel-blob.ts)
