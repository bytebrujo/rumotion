...
// @module: es2022
// @target: es2022
import {renderMediaOnVercel, addBundleToSandbox, createSandbox} from '@picus/vercel';
...
The ID of the Picus composition to render.
...
_string_ <TsType type="Codec" source="@picus/renderer" href="/docs/renderer/types#codec" />
...
_number | [number, number] | [number, null]_ <TsType type="FrameRange" source="@picus/renderer" href="/docs/renderer/types#framerange" />
...
_function_ <TsType type="RenderMediaOnVercelProgress" source="@picus/vercel" href="/docs/vercel/types#rendermediaonvercelprogress" />

A callback that receives progress updates. Every variant includes `overallProgress` (0–1).

```ts twoslash
import type {RenderMediaOnVercelProgress} from '@picus/vercel';
// ---cut---
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/vercel/src/render-media-on-vercel.ts)
