...
```ts twoslash
import {downloadMedia} from '@picus/lambda';

const {outputPath, sizeInBytes} = await downloadMedia({
  bucketName: 'picuslambda-r42fs9fk',
  region: 'us-east-1',
  renderId: '8hfxlw',
  outPath: 'out.mp4',
...
console.log(outputPath); // "/Users/yourname/picus-project/out.mp4"
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/download-media.ts)
