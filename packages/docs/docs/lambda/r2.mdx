...
id: r2
title: Using Picus Lambda with R2
...
[Many Picus users store](/docs/lambda/data-transfer-cost#option-1-use-an-alternate-cdn-for-storing-assets) their [bundle](/docs/terminology/bundle) and any assets such as input videos in R2, in order to avoid [S3 bandwidth costs](/docs/lambda/data-transfer-cost).

## See also

- [Using Picus Lambda with Supabase](/docs/lambda/supabase)
