...
```ts twoslash
import {deleteFunction, getFunctions} from '@picus/lambda';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/delete-function.ts)
