...
You have implemented your solution with Picus Lambda and are ready to launch your project into the world. Congrats!
...
If your video is based on user input, prevent your users from rendering very long videos that would exceed the space available in Picus Lambda.
...
Companies with more than 3 people need to buy cloud rendering seats in order to use Picus Lambda. Please familiarize yourself with the [license](https://github.com/picus-dev/picus/blob/main/LICENSE.md) and [buy the necessary cloud seats](https://www.picus.pro/) before launching.
