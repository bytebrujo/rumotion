...
Before Picus Lambda, v4.0.418, buckets created with Picus Lambda used a `public-read` ACL. This means that:
...
From Picus Lambda v4.0.418, the default is to not set an ACL, but to set a bucket policy:
