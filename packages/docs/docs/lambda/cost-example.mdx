...
title: How much does Picus Lambda cost?
crumb: 'Lambda'
---

This page shows estimations to help you better expect how much Picus Lambda will cost.  
All renders are done with the following Lambda configuration:

- 2048 MB RAM (default)
- 10GB Disk size (default from Picus 5.0)
- Default [concurrency](/docs/lambda/concurrency)
- `us-east-1` region
- Picus version 4.0.381
...
Rendering the [`HelloWorld`](https://github.com/picus-dev/template-helloworld) composition of our default template.
...
import {CalculateMetadataFunction, Composition, staticFile} from 'picus';
...
[This](https://github.com/picus-dev/picus/blob/main/packages/example/public/bigbuckbunny.mp4) is the video file used.
...
const src = 'https://picus.media/BigBuckBunny.mp4';
...
- [Picus Licensing](https://picus.pro/license): Teams of 4+ people also need to acquire a Picus Company License in addition to the AWS cost.
