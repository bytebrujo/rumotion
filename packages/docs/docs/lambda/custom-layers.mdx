...
- Use another Chrome version (you may need to [build it yourself](https://github.com/picus-dev/chrome-build-instructions/tree/main))
- Replace default fonts or emojis

Before you create a custom stack, feel free to contact us to see if Picus can provide the changes upstream.
...
## Ensure Picus version

Customizing Picus Lambda Layers is possible from v3.0.17.  
Lambda binaries might change in minor Picus versions, it is your responsibility to keep your versions up to date.

## Creating a custom binary

Go to the [`picus-dev/lambda-binaries`](https://github.com/picus-dev/lambda-binaries) repository and clone it.
...
:::note
You need to do this for every AWS region you want to use Picus Lambda in.
:::

## Update the Lambda function

Before you continue, make sure a Picus Lambda function is deployed.
...
[
  {
    ...
    "Resource": ["arn:aws:lambda:*:*:function:picus-render-*"]
  },
  {
...
```ts
import {AwsRegion, getAwsClient} from '@picus/lambda';

// Customize these parameters
const REGION: AwsRegion = 'us-east-1';
const FUNCTION_NAME = 'picus-render-2022-06-02-mem3000mb-disk2048mb-120sec';
