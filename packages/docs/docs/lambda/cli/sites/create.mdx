...
title: 'npx picus lambda sites create'
slug: /lambda/cli/sites/create
crumb: 'Lambda CLI Reference'
---

```
npx picus lambda sites create <entry-point>?
```
...
Bundle and upload a Picus video to an S3 bucket.

The result will be a URL such as `https://picuslambda-12345.s3.eu-central-1.amazonaws.com/sites/abcdef/index.html`.
...
<details>
  ...
  <pre>
    ...
    Deployed to S3!
    <br />
    Serve URL: https://picuslambda-12345.s3.eu-central-1.amazonaws.com/sites/abcdef/index.html
    <br />
    Site Name: abcdef
    <br />
  </pre>
...
```
npx picus lambda sites create src/index.ts --site-name=my-project
```
