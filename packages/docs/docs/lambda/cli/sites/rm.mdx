---
image: /generated/articles-docs-lambda-cli-sites-rm.png
sidebar_label: rm
title: 'npx picus lambda sites rm'
...
```bash
npx picus lambda sites rm abcdef
npx picus lambda sites rm abcdef my-project # multiple at once
```

<details>
  <summary>Example output</summary>
  <pre>
    Site abcdef in bucket picuslambda-gc1w0xbfzl (14.7 MB): Delete? (Y/n): Y
    <br />
...
```
npx picus lambda sites rm abcdef -y
```
