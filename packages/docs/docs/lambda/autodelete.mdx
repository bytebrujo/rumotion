...
- If you set up Picus Lambda after 4.0.32, you have it automatically.
- If you set up Picus Lambda previously, execute the following:
  1. Upgrade to at least Picus 4.0.32.
...
npx picus lambda sites create --site-name=my-site-name --enable-folder-expiry
```
...
```bash
npx picus lambda render testbed-v6 react-svg --delete-after="1-day"
```
