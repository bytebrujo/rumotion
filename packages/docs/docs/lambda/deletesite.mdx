...
Removes a Picus project from your S3 bucket.
...
```ts twoslash
import {AwsRegion, deleteSite, getSites} from '@picus/lambda';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/delete-site.ts)
