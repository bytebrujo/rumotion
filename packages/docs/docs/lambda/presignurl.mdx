...
```ts twoslash
import {presignUrl} from '@picus/lambda/client';
...
The bucket where the asset exists. The bucket must have been created by Picus Lambda.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/presign-url.ts)
