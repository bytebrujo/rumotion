...
```tsx twoslash
import {getCompositionsOnLambda} from '@picus/lambda/client';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/get-compositions-on-lambda.ts)
