...
title: "@picus/lambda - CLI"
slug: /lambda/cli
---

To use the Picus Lambda CLI, you first need to [install it](/docs/lambda/setup).
...
The default region is `us-east-1`. You may also set a `PICUS_AWS_REGION` environment variable directly or via `.env` file.
