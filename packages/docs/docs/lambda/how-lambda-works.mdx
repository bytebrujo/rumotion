...
id: how-lambda-works
title: How Picus Lambda works
crumb: 'Lambda'
---

This document describes the procedure that gets executed when a Picus Lambda video render is triggered.
...
<sup>1)</sup> An API for avoiding the S3 bandwidth charge is <a href="https://github.com/picus-dev/picus/issues/3817">planned</a>.
