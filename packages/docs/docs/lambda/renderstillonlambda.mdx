...
// @module: esnext
// @target: es2017
import {renderStillOnLambda} from '@picus/lambda/client';
...
import {renderStillOnLambda, RenderStillOnLambdaInput} from '@picus/lambda/client';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/lambda/src/api/render-still-on-lambda.ts)
