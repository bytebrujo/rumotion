...
On February 3rd 2022, AWS made a change to their Lambda micro-VMs that breaks Picus Lambda. This document contains information for affected users.
...
```
npx picus lambda functions deploy --architecture=x86_64
```
