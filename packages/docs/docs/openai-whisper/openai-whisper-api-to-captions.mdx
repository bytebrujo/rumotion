...
import {openAiWhisperApiToCaptions} from '@picus/openai-whisper';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/openai-whisper/src/openai-whisper-api-to-captions.ts)
- [`@picus/openai-whisper`](/docs/openai-whisper)
