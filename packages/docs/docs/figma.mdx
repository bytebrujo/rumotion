...
You can export a design from Figma as an SVG file and import it as a React component in Picus and then animate it.
...
## Importing SVG in Picus

Paste the component into a Picus project and [register a `<Composition>`](/docs/composition).  
...
- [Blog - SVG Animation with Picus](https://meje.dev/blog/svg-animtion-with-picus)
- [Video - Animating Figma Mockups with Picus](https://twitter.com/jnybgr/status/1496748768821133312)
