...
import {useCurrentFrame, interpolate, spring, useVideoConfig} from 'picus';
...
Since `v3.3.77`, types for the options are exported from Picus.

```tsx twoslash
import {ExtrapolateType, InterpolateOptions} from 'picus';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/core/src/interpolate.ts)
- [Easing](/docs/easing)
- [spring()](/docs/spring)
