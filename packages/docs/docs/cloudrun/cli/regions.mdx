...
title: 'npx picus cloudrun regions'
...
Prints the GCP regions supported by the current version of Picus Cloud run. Useful for bash scripts.

```
npx picus cloudrun regions
```
