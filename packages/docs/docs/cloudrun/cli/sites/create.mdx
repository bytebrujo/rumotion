---
image: /generated/articles-docs-cloudrun-cli-sites-create.png
sidebar_label: create
title: 'npx picus cloudrun sites create'
...
```bash
npx picus cloudrun sites create <entry-point>?
```
...
Bundle and upload a Picus video to a Cloud Storage bucket.

The result will be a URL such as `https://storage.googleapis.com/picuscloudrun-12345/sites/mySite123/index.html`.
...
```
npx picus cloudrun sites create src/index.ts --site-name=another-site
```
