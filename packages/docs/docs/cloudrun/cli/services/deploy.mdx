...
title: 'npx picus cloudrun services deploy'
...
Creates a new service in your GCP project. If a service exists in the same region, with the same Picus version, with the same amount of memory, disk space and timeout duration, the name of the already deployed service will be returned instead.
