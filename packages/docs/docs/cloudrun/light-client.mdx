...
The following methods and types can be imported from `@picus/cloudrun/client`:
...
Instead, this light client is meant to reduce the bundle size and avoid problems if you are calling Picus Cloud Run APIs from another serverless function and therefore need to bundle your function code.
