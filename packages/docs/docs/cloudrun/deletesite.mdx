...
Removes a Picus project from your Cloud Storage bucket.
...
```ts twoslash
import {GcpRegion, deleteSite, getSites} from '@picus/cloudrun';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/cloudrun/src/api/delete-site.ts)
