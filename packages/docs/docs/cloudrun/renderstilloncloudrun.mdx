...
Kicks off a still rendering process on Picus Cloud Run.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/cloudrun/src/api/render-still-on-cloudrun.ts)
