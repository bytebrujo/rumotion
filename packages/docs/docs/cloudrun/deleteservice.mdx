...
```ts twoslash
import {deleteService, getServices} from '@picus/cloudrun';
...
- [Source code for this service](https://github.com/picus-dev/picus/blob/main/packages/cloudrun/src/api/delete-service.ts)
