...
To use the Picus Cloud Run CLI, you first need to [install it](/docs/cloudrun/setup).
...
The default region is `us-east1`. You may also set a `PICUS_GCP_REGION` environment variable directly or via `.env` file.
