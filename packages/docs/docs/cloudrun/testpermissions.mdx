...
```ts twoslash
import {testPermissions} from '@picus/cloudrun';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/cloudrun/src/api/iam-validation/testPermissions.ts)
