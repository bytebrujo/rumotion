...
Adding a new option to a feature is a great way to contribute to Picus and enable more use cases.
...
- Options influencing a render can be added to the render dialog in the [Picus Studio](/docs/terminology/studio).
...
<br />
<Step>2</Step> Specified via the render UI in the <a href="/docs/terminology/studio">Picus Studio</a>
<br />
