...
title: Formatting in the Picus repo
sidebar_label: Formatting
crumb: Contributing
---

The Picus codebase uses Oxfmt and ESLint for formatting and requires all code to be formatted correctly before it is merged.
