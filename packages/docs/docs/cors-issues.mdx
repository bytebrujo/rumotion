...
<span style={{opacity: 0.5}}>`Access to fetch at 'https://google.com/' from origin 'https://picus.dev' has been blocked by CORS policy:` </span>
<br />
...
<span style={{opacity: 0.5}}>`Access to fetch at 'http://localhost:3005/' from origin 'https://www.picus.dev' has been blocked by CORS policy:`</span>
<br />
