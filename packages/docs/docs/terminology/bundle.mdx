...
You can create a bundle on the CLI using the [`npx picus bundle`](/docs/cli/bundle) command.

To bundle and deploy to S3, you can use the [`npx picus lambda sites create`](/docs/lambda/cli/sites/create) command.
