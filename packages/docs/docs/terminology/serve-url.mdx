...
A Serve URL is a URL under which [a Picus Bundle](/docs/terminology/bundle) is hosted.  
When rendering your video, Picus will open a headless browser and visit that URL in order to make screenshots of it.
