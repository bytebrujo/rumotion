		...
		<div>
			<Grid>
				...
				<TOCItem link="/docs/register-root">
					...
					<div>Initialize a Picus project</div>
				</TOCItem>
				...
				<TOCItem link="/docs/html5-video">
					...
					<div>
						Synchronize a <code>{'<video>'}</code> with Picus{"'"}s time
					</div>
				</TOCItem>
				<TOCItem link="/docs/html5-audio">
					<strong>{'<Html5Audio>'}</strong>
					<div>
						Synchronize <code>{'<audio>'}</code> with Picus{"'"}s time
					</div>
				</TOCItem>
				...
				<TOCItem link="/docs/get-picus-environment">
					<strong>getPicusEnvironment()</strong>
				...
				<TOCItem link="/docs/version">
					...
					<div>Get the current version of Picus</div>
				</TOCItem>
			</Grid>
		</div>
	);
