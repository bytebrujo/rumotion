...
import { getInstructionIndexAtLength } from "@picus/paths";
...
import { getInstructionIndexAtLength, parsePath } from "@picus/paths";
...
import { getInstructionIndexAtLength } from "@picus/paths";
// ---cut---
getInstructionIndexAtLength("picus", 50); // Error: Malformed path data: ...
```
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/get-instruction-index-at-length.ts)
