...
```ts twoslash
import { reduceInstructions, ReducedInstruction } from "@picus/paths";
...
```ts twoslash
import { ReducedInstruction } from "@picus/paths";
```
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/reduce-instructions.ts)
