...
```tsx twoslash
import { getTangentAtLength } from "@picus/paths";
...
import { getTangentAtLength } from "@picus/paths";
// ---cut---
getTangentAtLength("picus", 50); // Error: Malformed path data: ...
```
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/get-tangent-at-length.ts)
