...
```ts twoslash
import type { BoundingBox } from "@picus/paths";
```

## See also

- [`@picus/paths`](/docs/paths)
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/get-bounding-box.ts)
