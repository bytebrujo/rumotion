...
import { translatePath } from "@picus/paths";
// ---cut---
translatePath("picus", 10, 0); // Malformed path data: "m" ...
```
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/translate-path.ts)
