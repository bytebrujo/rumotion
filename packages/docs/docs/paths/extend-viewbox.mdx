...
_Part of the [`@picus/paths`](/docs/paths) package. Available since v3.2.25_
...
```tsx twoslash
import { extendViewBox } from "@picus/paths";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/extend-viewbox.ts)
