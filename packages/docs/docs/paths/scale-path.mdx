...
_Part of the [`@picus/paths`](/docs/paths) package. Available from v3.3.43_

Allows you to grow or shrink the size of a path.

```tsx twoslash title="scale-path.ts"
import { scalePath } from "@picus/paths";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/scale-path.ts)
