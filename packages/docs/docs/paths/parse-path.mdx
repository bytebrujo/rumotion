...
An array of `Instruction`'s. The `Instruction` type can also be imported from `@picus/paths`:
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/parse-path.ts)
