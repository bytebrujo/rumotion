...
```tsx twoslash
import { getPointAtLength } from "@picus/paths";
...
import { getPointAtLength } from "@picus/paths";
// ---cut---
getPointAtLength("picus", 50); // Error: Malformed path data: ...
```
...
```tsx twoslash
import { getLength, getPointAtLength } from "@picus/paths";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/paths/src/get-point-at-length.ts)
