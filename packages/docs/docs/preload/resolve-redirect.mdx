...
```tsx twoslash
import {resolveRedirect} from '@picus/preload';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/preload/src/resolve-redirect.ts)
- [Installing `@picus/preload`](/docs/preload)
