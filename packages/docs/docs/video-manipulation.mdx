...
import {AbsoluteFill, useVideoConfig, OffthreadVideo} from 'picus';
// ---cut---
...
export const Greenscreen: React.FC<{
  ...
  return (
    <AbsoluteFill>
      <AbsoluteFill>
        <OffthreadVideo style={{opacity: 0}} onVideoFrame={onVideoFrame} src="https://picus.media/greenscreen.mp4" />
      </AbsoluteFill>
      <AbsoluteFill>
        <canvas ref={canvas} width={width} height={height} />
      </AbsoluteFill>
...
Click [here](https://github.com/picus-dev/picus/blob/b966d0e99cfb91478ca697675f822284da1f9055/packages/docs/docs/video-manipulation.mdx) to see the old version of this page.
