...
crumb: 'FAQ'
title: Can Picus be used for live streaming?
sidebar_label: Live streaming
---

Picus is not designed for broadcasting. It's use case is to render fixed-length videos which content is deterministic from start to end.
...
Picus declarative approach based on browser APIs is not suitable for this use case.
...
You may create stinger transitions for OBS with Picus, see an [example](https://github.com/JonnyBurger/ledevevent-stinger) here.
