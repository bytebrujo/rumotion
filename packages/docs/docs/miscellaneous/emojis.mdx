...
## Emojis on Picus Lambda

[Noto Color Emoji are installed on Picus Lambda](/docs/lambda/runtime#fonts) by default.

You can [enable Apple Emojis](/docs/lambda/deployfunction#runtimepreference).

Replacing Emojis is possible by [customizing Picus Lambda](/docs/lambda/custom-layers).
