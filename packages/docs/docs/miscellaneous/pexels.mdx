---
image: /generated/articles-docs-miscellaneous-pexels.png
sidebar_label: Pexels videos
title: Timeouts with Pexels videos
crumb: 'Troubleshooting'
---

When including videos from Pexels, especially when rendering on Picus Lambda, you may encounter the following error:
...
```
A delayRender() "Loading <Img> with src=http://localhost:3000/proxy?src=https://videos.pexels.com/video-files/5182920/5182920-hd_720_1280_25fps.mp4" was called but not cleared after 28000ms. See https://picus.dev/docs/timeout for help
```
...
These timeouts are not a problem from Picus's side.
