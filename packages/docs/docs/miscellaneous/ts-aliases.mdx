...
:::warning
A common problem when enabling TypeScript aliases is that `import {} from "picus"` will start mapping to the `picus` folder that you may have in your project, like is the case in some of our templates.
