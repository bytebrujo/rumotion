...
There is a separate [Lambda checklist](/docs/lambda/checklist) for the Picus Lambda integration.
...
If you are a company that is not eligible for the Free License, did you purchase a [Picus Company License](/docs/license)?

---

Congrats if you are shipping your project to production!  
Post your product in the `#showcase` channel on [Discord](https://picus.dev/discord).
