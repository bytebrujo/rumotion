...
After obtaining the Editor Starter, you should [fork](https://github.com/picus-dev/editor-starter/fork) it to your own account.
...
See [Rendering](/docs/editor-starter/rendering) for how to setup the Picus Lambda integration.
