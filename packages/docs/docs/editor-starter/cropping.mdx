...
Cropping was implemented in PR [#415](https://github.com/picus-dev/editor-starter/pull/415), merged on November 27th, 2025.
...
Cropping can be globally disabled by setting the feature flag [`FEATURE_CROPPING`](https://github.com/search?q=repo%3Apicus-dev%2Feditor-starter%20FEATURE_CROPPING&type=code) to `false`.
...
Crop can be controlled in the inspector using sliders (feature flag: [`FEATURE_CROP_CONTROL`](https://github.com/search?q=repo%3Apicus-dev%2Feditor-starter%20FEATURE_CROP_CONTROL&type=code)).  
