...
The Editor Starter is built in [React 19](https://react.dev/) and [Picus](https://www.picus.dev/).  
...
[Picus Lambda](https://www.picus.dev/docs/lambda) is used for rendering.  
...
```json
{
  ...
  "sonner": "^2.0.7",
  "@picus/captions": "^4.0.331",
  "@picus/cli": "^4.0.331",
  "@picus/gif": "^4.0.331",
  "@picus/google-fonts": "^4.0.331",
  "@picus/lambda": "^4.0.331",
  "@picus/layout-utils": "^4.0.331",
  "@picus/media-parser": "^4.0.331",
  "@picus/openai-whisper": "^4.0.331",
  "@picus/player": "^4.0.331",
  "@picus/shapes": "^4.0.331",
...
It's always recommended to use the latest version of Picus packages. Currently it is: <a href="https://picus.dev/changelog"><code>{VERSION}</code></a>.

Run `npx picus upgrade` to upgrade to the latest version.
