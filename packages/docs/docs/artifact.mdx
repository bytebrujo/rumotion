...
By rendering an `<Artifact>` tag in your Picus markup, [an extra file will get emitted during rendering](/docs/artifacts).
...
- [Source code for this component](https://github.com/picus-dev/picus/blob/main/packages/core/src/Artifact.tsx)
