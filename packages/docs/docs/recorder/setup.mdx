...
Scaffold a new Picus Recorder project:
...
The Picus Recorder requires [Bun](https://bun.sh/), with the minimum version being 1.2. To install it, run
...
## 5. Run the Picus Recorder

Once done, you are ready to start the Picus Recorder:
