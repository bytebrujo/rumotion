...
<p align="center">
  <picture>
    ...
    <img alt="Animated Picus Recorder Logo" src="/recorder/recorder-logo-light.gif" />
  </picture>
</p>

The Picus Recorder is a video production tool <strong>built entirely in JavaScript</strong>.
