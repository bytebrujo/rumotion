...
We plan to add this as a Picus feature and then enable it in the Recorder.
...
We plan to add new Picus APIs and Picus Studio features to make edits easier than having to use the props editor.

## Give us feedback

Let us know on the [`#recorder`](https://picus.dev/recorder) channel what you would like to see next.
