...
These constraints are defined in [`picus/scenes/BRoll/apply-b-roll-rules.ts`](https://github.com/picus-dev/recorder/tree/main/picus/scenes/BRoll/apply-b-roll-rules.ts).
