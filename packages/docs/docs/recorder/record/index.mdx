...
If you haven't done so, start the Picus Recorder:
...
You can record more sources, but out of the box, the Picus Recorder does not do anything with them.
...
You can also use the hosted version of the recoding interface at [record.picus.dev](https://record.picus.dev).
...
To copy the recordings to your Picus project, first open `copy.ts` in your code editor. Set the `prefix` at the top of your file to the ID of the composition that you gave when you first created a new video.
