...
<Step>1</Step> File an issue under <a href="https://picus.dev/issue">picus.dev/issue</a> <br/>
<Step>2</Step> Write in the <code>#help</code> channel or <code>#help-forum</code> on <a href="https://picus.dev/discord">picus.dev/discord</a>
...
Always mention the Picus version:
...
<Step>2</Step> Search over 1100+ <a href="https://github.com/picus-dev/picus/issues">GitHub issues</a> and 400+ <a href="/search">documentation pages</a>. <br/>
