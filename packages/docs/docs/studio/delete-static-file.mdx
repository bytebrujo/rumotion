...
This API is useful for building interactive experiences in the [Picus Studio](/docs/terminology/studio).
...
<Step>1</Step> This API can only be used while in the Picus Studio.
<br />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/delete-static-file.ts)
