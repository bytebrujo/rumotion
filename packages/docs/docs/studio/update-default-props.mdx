...
// @target: esnext
import { updateDefaultProps } from "@picus/studio";
...
// @target: esnext
import { saveDefaultProps } from "@picus/studio";
...
<Step>1</Step> You need to be inside the Picus Studio.
<br />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/update-default-props.ts)
