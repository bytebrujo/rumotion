...
Jump to a position in time in the Picus Studio.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/seek.ts)
