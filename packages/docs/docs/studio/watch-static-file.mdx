...
:::note
This API is being moved from the <code>picus</code> package.  
...
import { StaticFile, watchStaticFile } from "@picus/studio";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/watch-static-file.ts)
