...
:::note
In environments outside the Picus Studio, this API returns an empty array.  
:::
...
import {getStaticFiles, StaticFile} from '@picus/studio';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/get-static-files.ts)
