...
:::warning
**Preview feature:** A few issues are known, and filed under this [issue](https://github.com/picus-dev/picus/issues/5210).
:::

Creates a control in the right sidebar of the [Picus Studio](/docs/studio) that allows you to change a value.
...
Instead of changing the value of `rotation` in the code, you can create a control in the right sidebar of the [Picus Studio](/docs/studio) that allows you to change the value:
...
Now, in the right sidebar of the [Picus Studio](/docs/studio), you will see a control with the name `rotation` and a slider to change the value.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/studio/src/api/visual-control.ts)
