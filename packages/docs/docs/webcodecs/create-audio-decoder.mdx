...
import {createAudioDecoder} from '@picus/webcodecs';
...
- Only samples with a size of 16 bytes or more are actually being input, [to avoid a bug in Chrome](https://github.com/picus-dev/picus/blob/c7f18a85bcb1bc58d3811efcd9e68c96ff38ccae/packages/webcodecs/src/create-audio-decoder.ts#L121-L129).
...
## Example usage with `@picus/media-parser`
...
import {AudioUndecodableError, createAudioDecoder} from '@picus/webcodecs';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/create-audio-decoder.ts)
