...
import {canReencodeVideoTrack} from '@picus/webcodecs';
...
- [Source code for this function on GitHub](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/can-reencode-video-track.ts)
