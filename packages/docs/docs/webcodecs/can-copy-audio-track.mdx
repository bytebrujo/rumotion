...
import {canCopyAudioTrack} from '@picus/webcodecs';
...
import {convertMedia, canCopyAudioTrack} from '@picus/webcodecs';
...
_string_ <TsType type="MediaParserAudioCodec" source="@picus/media-parser" />
...
_string | null_ <TsType type="ConvertMediaAudioCodec" source="@picus/webcodecs" />
...
- [Source code for this function on GitHub](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/can-copy-audio-track.ts)
