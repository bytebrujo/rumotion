...
You can convert a video in the browser from one format to another using the [`convertMedia()`](/docs/webcodecs/convert-media) function from [`@picus/webcodecs`](/docs/webcodecs).
...
Install the `@picus/webcodecs` and `@picus/media-parser` packages:

<Installation pkg="@picus/webcodecs @picus/media-parser" />
<br />
<details>
