...
import {rotateAndResizeVideoFrame} from '@picus/webcodecs';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/rotate-and-resize-video-frame.ts)
