...
A writer for `@picus/webcodecs` that writes to the browser's file system using the File System Access API.
...
import {webFsWriter} from '@picus/webcodecs/web-fs';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/writers/web-fs.ts)
