...
import {convertAudioData} from '@picus/webcodecs';
...
The new sample rate. Must be between 3000 and 768000 (only Chrome enforces this technically, but Picus will throw an error always).
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/convert-audiodata.ts)
