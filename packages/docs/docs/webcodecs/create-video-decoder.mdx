...
import {createVideoDecoder} from '@picus/webcodecs';
...
import {VideoUndecodableError, createVideoDecoder} from '@picus/webcodecs';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/create-video-decoder.ts)
