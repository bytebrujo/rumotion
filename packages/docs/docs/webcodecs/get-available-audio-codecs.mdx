...
import {getAvailableAudioCodecs} from '@picus/webcodecs';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/get-available-audio-codecs.ts)
