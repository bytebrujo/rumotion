...
## Re-encoding using `@picus/webcodecs`

You can also re-encode the video in the browser using the new and experimental [`@picus/webcodecs`](/docs/webcodecs) package.
...
<details>
  <summary>💼 Important License Disclaimer about `@picus/webcodecs`</summary>
  <LicenseDisclaimer />
</details>
<details>
...
## Re-muxing using `@picus/webcodecs`
...
Use [picus.dev/convert](https://picus.dev/convert) to fix a MediaRecorder video online using WebCodecs.  
See the [source code](https://github.com/picus-dev/picus/tree/main/packages/convert) for a reference on how to implement it.
...
- [`@picus/media-parser`](/docs/media-parser)
