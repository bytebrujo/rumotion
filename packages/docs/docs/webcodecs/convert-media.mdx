...
Re-encodes a video using [WebCodecs](https://developer.mozilla.org/en-US/docs/Web/API/WebCodecs_API) and [`@picus/media-parser`](/docs/media-parser).
...
_string_ <TsType type="ConvertMediaContainer" source="@picus/webcodecs"/>
...
_string_ <TsType type="ConvertMediaVideoCodec" source="@picus/webcodecs"/>
...
_string_ <TsType type="ConvertMediaAudioCodec" source="@picus/webcodecs"/>
...
_object_ <TsType type="ResizeOperation" source="@picus/webcodecs"/>

Resize the video. See [Resize a video](/docs/webcodecs/resize-a-video) for more information.

### `logLevel?`

_string_ <TsType type="LogLevel" source="@picus/media-parser"/>
...
_Function_ <TsType type="ConvertMediaOnProgress" source="@picus/media-parser"/>

Allows receiving progress updates. The following fields are available:

```tsx twoslash
import type {ConvertMediaOnProgress, ConvertMediaProgress} from '@picus/webcodecs';
...
_Function_ <TsType type="ConvertMediaOnVideoFrame" source="@picus/media-parser"/>
...
```tsx twoslash
import type {ConvertMediaOnVideoFrame} from '@picus/webcodecs';
...
_Function_ <TsType type="ConvertMediaOnAudioData" source="@picus/media-parser"/>
...
```tsx twoslash
import type {ConvertMediaOnAudioData} from '@picus/webcodecs';
...
_object_ <TsType type="WriterInterface" source="@picus/webcodecs" />
...
import {canUseWebFsWriter, webFsWriter} from '@picus/webcodecs/web-fs';
//                          ^?
...
_Function_ <TsType type="ConvertMediaOnAudioTrackHandler" source="@picus/webcodecs"/>
...
_Function_ <TsType type="ConvertMediaOnVideoTrackHandler" source="@picus/webcodecs"/>
...
_Function_ <TsType type="SelectM3uStreamFn" source="@picus/media-parser"/>
...
[See notes about `@picus/webcodecs`](/docs/webcodecs#-license-disclaimer).

## See also

- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/webcodecs/src/convert-media.ts)
- [`@picus/webcodecs`](/docs/webcodecs)
