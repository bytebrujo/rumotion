...
_Part of the [`@picus/fonts`](/docs/fonts) package_

Load a local font for use in Picus.  
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/fonts/src/load-font.ts)
- [Fonts](/docs/fonts)
