...
title: '@picus/install-whisper-cpp'
crumb: 'Transcribe audio locally'
---

# @picus/install-whisper-cpp<AvailableFrom v="4.0.115" />
...
<Installation pkg="@picus/install-whisper-cpp" />
...
import {downloadWhisperModel, installWhisperCpp, transcribe, toCaptions} from '@picus/install-whisper-cpp';
import fs from 'fs';
