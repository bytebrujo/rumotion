...
import {installWhisperCpp} from '@picus/install-whisper-cpp';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/install-whisper-cpp/src/install-whisper-cpp.ts)
