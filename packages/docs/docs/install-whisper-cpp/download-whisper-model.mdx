...
import {downloadWhisperModel} from '@picus/install-whisper-cpp';
...
```tsx twoslash
import type {OnProgress} from '@picus/install-whisper-cpp';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/install-whisper-cpp/src/download-whisper-model.ts)
