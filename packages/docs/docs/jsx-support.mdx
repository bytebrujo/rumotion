...
Since Picus 1.3, you can opt out of Typescript and it's type checking advantages in Picus. Continue at your own risk.
...
If you upgrade from Picus 1.2 or older, consider changing the `npm test` command to also include JavaScript files, and to remove the `tsc` command:
