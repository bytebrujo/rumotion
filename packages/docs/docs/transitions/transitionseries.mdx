...
// ---cut---
import {linearTiming, springTiming, TransitionSeries} from '@picus/transitions';
...
import {springTiming} from '@picus/transitions';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/transitions/src/TransitionSeries.tsx)
