...
import { WipeDirection } from "@picus/transitions/wipe";
...
- [Source code for this presentation](https://github.com/picus-dev/picus/blob/main/packages/transitions/src/presentations/wipe.tsx)
