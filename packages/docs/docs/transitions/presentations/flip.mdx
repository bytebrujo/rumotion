...
import { FlipDirection } from "@picus/transitions/flip";
...
- [Source code for this presentation](https://github.com/picus-dev/picus/blob/main/packages/transitions/src/presentations/flip.tsx)
