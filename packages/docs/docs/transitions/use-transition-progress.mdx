...
import { useTransitionProgress } from "@picus/transitions";
...
- [Source code for this hook](https://github.com/picus-dev/picus/blob/main/packages/transitions/src/use-transition-progress.ts)
