...
import type { TransitionTiming } from "@picus/transitions";
...
import type { TransitionTiming } from "@picus/transitions";
import { measureSpring, spring, SpringConfig } from "picus";
...
import { TransitionPresentation } from "@picus/transitions";
...
See the source code for already implemented timings [here](https://github.com/picus-dev/picus/blob/main/packages/transitions/src/timings).
