...
title: Importing .srt subtitles into Picus
crumb: Captions
---

# Importing .srt subtitles into Picus

If you have an existing `.srt` subtitle file, you can import it into Picus using [`parseSrt()`](/docs/captions/parse-srt) from `@picus/captions`.
...
Once parsed, the captions are in the recommended [`Caption`](/docs/captions/caption) format and can be used with all `@picus/captions` utilities.
