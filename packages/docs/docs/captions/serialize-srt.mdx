...
import {serializeSrt, Caption} from '@picus/captions';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/captions/src/serialize-srt.ts)
