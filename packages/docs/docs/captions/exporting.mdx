...
This guide covers different ways to export subtitles from your Picus video.
...
import {serializeSrt} from '@picus/captions';
...
import {serializeSrt, createTikTokStyleCaptions} from '@picus/captions';
import type {Caption} from '@picus/captions';
