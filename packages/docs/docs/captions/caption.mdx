...
- **Transcribing**: Using the [`@picus/install-whisper-cpp`](/docs/install-whisper-cpp) or [`@picus/openai-whisper`](/docs/openai-whisper) packages
...
When using [`@picus/install-whisper-cpp`](/docs/install-whisper-cpp), this the `t_dtw` value.  
...
- [Source code for this type](https://github.com/picus-dev/picus/blob/main/packages/captions/src/caption.ts)
