...
You can give your sequence a name and it will be shown as the label of the sequence in the timeline of the Picus Studio. This property is purely for helping you keep track of sequences in the timeline.
...
- [Source code for this component](https://github.com/picus-dev/picus/blob/main/packages/core/src/Sequence.tsx)
