...
Registers a usage point for your Picus license.  
Allows for accurate and up to date reporting and to track your usage on the Picus dashboard.

```tsx twoslash title="Register a usage point"
import {registerUsageEvent} from '@picus/licensing';
...
Your Picus public API key. You can get it from your Picus.pro dashboard.
