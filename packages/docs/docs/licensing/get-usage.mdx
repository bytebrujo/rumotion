...
crumb: '@picus/licensing'
---

Allows you to get the current usage of your Picus license.  
This requires your secret key that you can obtain from the picus.pro dashboard.
...
import {getUsage} from '@picus/licensing';
...
Your Picus license key. You can get it from your Picus.pro dashboard.
...
Your Picus secret API key. You can get it from your Picus.pro dashboard.
...
- [`@picus/licensing`](/docs/licensing)
