...
To use Picus, you need at least [Node](https://nodejs.org/en/download/) <MinNodeVersion /> or [Bun](https://bun.sh) <MinBunVersion />.
...
:::note
🐧 [Linux distros need at least version 2.35 of Libc.](https://github.com/picus-dev/picus/issues/2439)  
...
After the project has been scaffolded, we recommend to open the project in your text editor and starting the [Picus Studio](/docs/studio):
...
To start the [Picus Studio](/docs/studio):
...
Want to install Picus in an existing project? Go here instead: [Installation in existing projects](/docs/brownfield)
