...
_Part of the [`@picus/layout-utils`](/docs/layout-utils) package. Available from v4.0.88_
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/layout-utils/src/layouts/fit-text.ts)
- [`@picus/layout-utils`](/docs/layout-utils)
- [`@picus/google-fonts`](/docs/google-fonts)
