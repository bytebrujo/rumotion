...
<Step>1</Step> Open your project in the Picus Studio and select the
...
<Step>4</Step> Open the Chrome DevTools and select the `<div id="picus-measurer">` node in the "Elements" tab.<br/>
...
- [Source code for `measureText()`](https://github.com/picus-dev/picus/blob/main/packages/layout-utils/src/layouts/measure-text.ts)
