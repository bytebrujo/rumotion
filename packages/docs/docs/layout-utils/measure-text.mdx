...
_Part of the [`@picus/layout-utils`](/docs/layout-utils) package._
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/layout-utils/src/layouts/measure-text.ts)
