...
- `defaultProps`: Only the default props, taken from the [`defaultProps`](/docs/composition#defaultprops) prop or the Picus Studio Data sidebar.
...
The function will get executed every time the props in the [Picus Studio](/docs/visual-editing) changes.
