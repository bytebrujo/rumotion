...
_string_ <TsType type="RenderStillOnWebImageFormat" source="@picus/web-renderer" href="/docs/web-renderer/types#renderstillonwebimageformat" />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/web-renderer/src/render-still-on-web.tsx)
