...
import {canRenderMediaOnWeb} from '@picus/web-renderer';
...
_string_ <TsType type="WebRendererContainer" source="@picus/web-renderer" />

The container format. Default is `"mp4"`.

### `videoCodec?`

_string_ <TsType type="WebRendererVideoCodec" source="@picus/web-renderer" />
...
_string | null_ <TsType type="WebRendererAudioCodec" source="@picus/web-renderer" />
...
_number | string_ <TsType type="WebRendererQuality" source="@picus/web-renderer" />
...
_string | null_ <TsType type="WebRendererOutputTarget" source="@picus/web-renderer" />
...
<TsType type="CanRenderIssue[]" source="@picus/web-renderer" />
...
<TsType type="WebRendererOutputTarget" source="@picus/web-renderer" />
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/web-renderer/src/can-render-media-on-web.ts)
