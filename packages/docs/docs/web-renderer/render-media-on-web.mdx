...
_Part of the `@picus/web-renderer` package._
...
_string_ <TsType type="WebRendererContainer" source="@picus/web-renderer" href="/docs/web-renderer/types#webrenderercontainer" />

The container format to use for the output video. Default is `mp4`.

### `videoCodec?`

_string_ <TsType type="WebRendererVideoCodec" source="@picus/web-renderer" href="/docs/web-renderer/types#webrenderervideocodec" />
...
_number | [number, number] | [number, null]_ <TsType type="FrameRange" source="@picus/web-renderer" href="/docs/web-renderer/types#framerange" />
...
_function_ <TsType type="RenderMediaOnWebProgressCallback" source="@picus/web-renderer" href="/docs/web-renderer/types#rendermediaonwebprogresscallback" />
...
_number | string_ <TsType type="WebRendererQuality" source="@picus/web-renderer" href="/docs/web-renderer/types#webrendererquality" />
...
_string_ <TsType type="WebRendererAudioCodec" source="@picus/web-renderer" href="/docs/web-renderer/types#webrendereraudiocodec" />
...
_string_ <TsType type="LogLevel" source="picus" />
...
_function_ <TsType type="WebRendererOnArtifact" source="@picus/web-renderer" href="/docs/web-renderer/types#webrendereronartifact" />
...
_function_ <TsType type="OnFrameCallback" source="@picus/web-renderer" href="/docs/web-renderer/types#onframecallback" />
...
_string_ <TsType type="WebRendererOutputTarget" source="@picus/web-renderer" href="/docs/web-renderer/types#webrendereroutputtarget" />
...
By default, Picus will automatically choose `"web-fs"` if available, otherwise `"arraybuffer"`.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/web-renderer/src/render-media-on-web.tsx)
