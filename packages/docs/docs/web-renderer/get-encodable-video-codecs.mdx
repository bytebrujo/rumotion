...
import {getEncodableVideoCodecs} from '@picus/web-renderer';
...
_string_ <TsType type="WebRendererContainer" source="@picus/web-renderer" /> - required

The container format: `"mp4"` or `"webm"`.

### `options?`

_object_ <TsType type="GetEncodableVideoCodecsOptions" source="@picus/web-renderer" />
