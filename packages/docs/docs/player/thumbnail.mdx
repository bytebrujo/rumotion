...
```tsx twoslash
import {RenderLoading, Thumbnail} from '@picus/player';
...
```tsx twoslash
import {ThumbnailRef} from '@picus/player';
import {useEffect, useRef} from 'react';
// ---cut---
const thumbnailRef = useRef<ThumbnailRef>(null);
...
- [Source code for this component](https://github.com/picus-dev/picus/blob/main/packages/player/src/Thumbnail.tsx)
