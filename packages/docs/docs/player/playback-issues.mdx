...
We have implemented exact logging of relevant events so in order to improve how Picus handles media playback.  
We are encouraging you to file feedback. If you would like to report feedback, please:

<div>
  <Step>1</Step> <span>Ensure you are at least on v4.0.302 of Picus. Previous versions had known bugs.</span>
</div>
<div>
  <Step>2</Step>{' '}
  <span>
