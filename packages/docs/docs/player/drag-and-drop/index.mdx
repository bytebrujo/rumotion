...
title: 'Drag & Drop in the Picus Player'
crumb: '@picus/player'
no_ai: true
---
...
The Picus Player supports reacting to mouse events allowing for building interactions on the canvas.  
...
We can now render the Main component that we created in the Picus Player.
...
- [Source code for this demo](https://github.com/picus-dev/picus/blob/main/packages/docs/docs/player/drag-and-drop/Demo.tsx)
