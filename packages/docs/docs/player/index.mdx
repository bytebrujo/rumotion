...
Using the Picus Player you can embed Picus videos in any React app and customize the video content at runtime.
...
See the [source code](https://github.com/picus-dev/picus/blob/main/packages/docs/components/PlayerExampleWithControls.tsx) for this example.
