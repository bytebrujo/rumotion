...
Renders an animated GIF, PNG, AVIF or WebP image and syncs it with Picus's timeline.  
...
import {AnimatedImage} from 'picus';
...
- [Source code for this component](https://github.com/picus-dev/picus/blob/main/packages/core/src/animated-image/AnimatedImage.tsx)
- [`<Gif>`](/docs/gif)
