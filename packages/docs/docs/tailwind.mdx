...
1. Install [`@picus/tailwind-v4`](/docs/tailwind-v4/overview) package and TailwindCSS dependencies.
...
```bash
npm i -D @picus/tailwind-v4 tailwindcss
```
...
```bash
yarn add -D @picus/tailwind-v4 tailwindcss
```
...
```bash
pnpm i -D @picus/tailwind-v4 tailwindcss
```
...
```bash
bun i -D @picus/tailwind-v4 tailwindcss
```

  </TabItem>
</Tabs>

2. Add the Webpack override from `@picus/tailwind-v4` to your config file:
...
_from v3.3.95, see [instructions for older versions](https://github.com/picus-dev/picus/blob/88a5d8d17f50d6ab2b8a408556118d15a3686343/packages/docs/docs/tailwind.md)_

1. Install [`@picus/tailwind`](/docs/tailwind/tailwind) package and TailwindCSS dependencies.
...
```bash
bun i -D @picus/tailwind
```

  </TabItem>
</Tabs>

2. Add the Webpack override from `@picus/tailwind` to your config file:
