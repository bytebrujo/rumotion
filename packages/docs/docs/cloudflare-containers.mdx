...
See our [demo](https://github.com/picus-dev/cloudflare-containers-demo) to deploy a Picus project to Cloudflare Containers.

## Limitations

The above repository is a proof of concept focusing on the integration of Picus with Cloudflare Containers.  
