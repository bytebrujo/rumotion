...
_Part of the `@picus/media-utils`_ package of helper functions.
...
import {createSmoothSvgPath, useAudioData, visualizeAudioWaveform, AudioData} from '@picus/media-utils';
import React from 'react';
import {AbsoluteFill, Audio, useCurrentFrame, useVideoConfig, staticFile} from 'picus';
...
```tsx twoslash
import {createSmoothSvgPath, useAudioData, visualizeAudioWaveform} from '@picus/media-utils';
import React from 'react';
import {AbsoluteFill, Html5Audio, useCurrentFrame, useVideoConfig, staticFile} from 'picus';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-utils/src/visualize-audio-waveform.ts)
