...
```tsx twoslash
import {createSmoothSvgPath} from '@picus/media-utils';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-utils/src/create-smooth-svg-path.ts)
