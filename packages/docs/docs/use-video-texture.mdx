...
Allows you to use a video in React Three Fiber that is synchronized with Picus's `useCurrentFrame()`.
...
// ---cut---
import {useVideoTexture} from '@picus/three';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/three/src/use-video-texture.ts)
