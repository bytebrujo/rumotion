...
Picus would not be possible without the work of many others.

## Software acknowledgements

| Software       | License                                                            | Source Code                                                         | Notes                                                                                                  |
| :------------- | :----------------------------------------------------------------- | :------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------- |
| **FFmpeg**     | [LGPLv2.1](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) | [View Source](https://github.com/picus-dev/rust-ffmpeg-splitter) | Core video processing code ([ffmpeg.org](http://ffmpeg.org))                                           |
...
Picus depends on many JavaScript packages. View the list of packages for each package that we distribute [here](https://github.com/picus-dev/picus/tree/main/packages).

## Contributors

More than [300 people](https://github.com/picus-dev/picus/graphs/contributors) have contributed to the Picus codebase.
