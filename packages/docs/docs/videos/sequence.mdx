...
import {OffthreadVideo, Series} from 'picus';
...
```tsx twoslash title="VideosInSequence.tsx"
import React from 'react';
import {OffthreadVideo, staticFile, Series, CalculateMetadataFunction} from 'picus';
...
import React from 'react';
import {OffthreadVideo, Series, useVideoConfig} from 'picus';
