...
title: Embedding videos into Picus
sidebar_label: Adding a video
crumb: 'How To'
---

You can embed existing videos into Picus by using the [`<OffthreadVideo>`](/docs/offthreadvideo) component.
...
```tsx twoslash
import React from 'react';
import {OffthreadVideo, staticFile, Sequence} from 'picus';
