...
import {getAvailableModels} from '@picus/whisper-web';
...
- [Source code for `getAvailableModels()`](https://github.com/picus-dev/picus/blob/main/packages/whisper-web/src/get-available-models.ts)
