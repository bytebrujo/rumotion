...
```tsx twoslash title="Transcribing with @picus/whisper-web"
import {transcribe, canUseWhisperWeb, resampleTo16Khz, downloadWhisperModel} from '@picus/whisper-web';
