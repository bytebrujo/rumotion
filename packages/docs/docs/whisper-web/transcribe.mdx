...
import {resampleTo16Khz} from '@picus/whisper-web';
...
// ---cut---
import {transcribe} from '@picus/whisper-web';
...
- [Source code for `transcribe()`](https://github.com/picus-dev/picus/blob/main/packages/whisper-web/src/transcribe.ts)
