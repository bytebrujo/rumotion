...
```ts twoslash
import {useCurrentFrame, interpolateColors} from 'picus';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/core/src/interpolate-colors.ts)
