...
_Part of the [`@picus/noise`](/docs/noise) package._
...
```tsx twoslash
import { noise4D } from "@picus/noise";
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/noise/src/index.ts)
- [`@picus/noise`](/docs/noise)
