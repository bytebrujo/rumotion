...
The [`<LightLeak>`](/docs/light-leaks/light-leak) component from [`@picus/light-leaks`](/docs/light-leaks/api) renders a WebGL-based light leak effect. The effect reveals during the first half of its duration and retracts during the second half.
...
- [`@picus/light-leaks`](/docs/light-leaks/api)
