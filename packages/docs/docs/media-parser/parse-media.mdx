...
_Part of the [`@picus/media-parser`](/docs/media-parser) package._
...
import {parseMedia, MediaParserOnVideoTrack} from '@picus/media-parser';
...
// @noErrors
import {parseMedia, MediaParserOnAudioTrack} from '@picus/media-parser';
...
```tsx twoslash
import {ParseMediaProgress} from '@picus/media-parser';
//          ^?
```
...
Acknowledge the [Picus License](https://picus.dev/license) to make the console message disappear.
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-parser/src/parse-media.ts)
