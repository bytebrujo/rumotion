...
<Installation pkg="@picus/media-parser" />
...
- Unlike FFmpeg, Picus Media Parser does not have functionality for decoding and encoding – it only parses media files.  
...
Picus Media Parser supports more [container formats](/docs/media-parser/format-support), with the goal that it can handle arbitrary user-provided media files.
...
<table>
  <tr>
    ...
    <td>
      <a href="https://tella.com">Tella</a> for boosting the development of @picus/media-parser with $10.000!
    </td>
  </tr>
</table>
