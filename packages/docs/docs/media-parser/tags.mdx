...
[`@picus/media-parser`](/docs/media-parser) allows you to extract metadata that is embedded in video files, such as ID3 tags or EXIF data.
...
| `comment`                                                 | ID3 Comment Tag                                                                                                                                                                                                                                      | `"Made with Picus 4.0.234"`                           |
...
| `comment`  | Software used to encode stream/Video | `"Made with Picus 4.0.192"` |
