...
id: metadata
title: Getting metadata from videos using @picus/media-parser
...
Using [`@picus/media-parser`](/docs/media-parser), you can get metadata from a [variety of media formats](/docs/media-parser/format-support).
