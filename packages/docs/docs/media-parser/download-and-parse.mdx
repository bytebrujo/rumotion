...
[`@picus/media-parser`](/docs/media-parser) allows you to download a remote video to disk, and while the media is downloading, retrieve metadata from it as soon as it is available.
