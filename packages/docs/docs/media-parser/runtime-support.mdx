...
[`@picus/media-parser`](/docs/media-parser) works in the Browser, Node.js and Bun.
...
WebCodecs support is not tied to `@picus/media-parser` itself, but if you use it to decode video and audio, you :
...
See also: [Can I use WebCodecs?](https://caniuse.com/webcodecs)
