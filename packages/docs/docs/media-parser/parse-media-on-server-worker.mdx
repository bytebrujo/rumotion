...
import {parseMediaOnServerWorker} from '@picus/media-parser/server-worker';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-parser/src/server-worker.module.ts)
