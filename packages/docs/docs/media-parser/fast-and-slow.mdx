...
[`@picus/media-parser`](/docs/media-parser) allows you to specify the information that you want to obtain.  
...
Otherwise, `@picus/media-parser` has no choice but to read the full file if the metadata is at the end of it.
