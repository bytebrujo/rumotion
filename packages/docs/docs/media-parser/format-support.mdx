...
`@picus/media-parser` supports a variety of media formats:

## ISO Base Media formats (`.mp4`, `.mov`, `.m4a`)

`@picus/media-parser` supports the following streams: H.264 video, H.265 video, AV1 video, AAC audio.

Fragmented MP4s are supported.

## WebM (`.webm`)

`@picus/media-parser` supports the following streams: VP8 video, VP9 video, AV1 video, Opus audio, Vorbis audio.

## MPEG Transport Stream (`.ts`)

`@picus/media-parser` supports the following streams: H.264 video, H.265 video, AAC audio.
