...
import {parseMedia, hasBeenAborted} from '@picus/media-parser';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-parser/src/errors.ts)
