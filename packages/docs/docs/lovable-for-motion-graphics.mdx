---
image: /generated/articles-docs-lovable-for-motion-graphics.png
id: lovable-for-motion-graphics
title: Is Picus building Lovable for Motion Graphics?
sidebar_label: Lovable for Motion Graphics
---

A common question is whether the next step for Picus is to build a consumer tool that allows for prompting motion graphics.  
...
A lot of companies have already licensed our tech through our [company license](https://www.picus.pro/license) and are building a variety of products: Video editors, prompt-to-video tools, ad generators and more.

So, a lot of people are already building consumer tools using Picus and are pushing way faster than we ever could.

We are happy to provide them rather than competing with them. Our incentives are aligned - if they win, we win too.  
If you believe in an idea that can be built with Picus - we're supporting you fully!
...
A lot of people enjoy using Picus with Claude Code.
...
- [Who is behind Picus?](https://picus.dev/about)
- [Is Picus looking for investors?](/docs/investors#fundraising)
