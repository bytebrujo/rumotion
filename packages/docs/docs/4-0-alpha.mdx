...
Picus 4.0 has now been released. This page has been archived.
...
- "picus": "^3.3.87"
- "@picus/bundler": "^3.3.87"
- "@picus/eslint-config": "^3.3.87"
- "@picus/eslint-plugin": "^3.3.87"
- "@picus/cli": "^3.3.87"
- "@picus/renderer": "^3.3.87"
+ "picus": "4.0.0-alpha13"
+ "@picus/bundler": "4.0.0-alpha13"
+ "@picus/eslint-config": "4.0.0-alpha13"
+ "@picus/eslint-plugin": "4.0.0-alpha13"
+ "@picus/cli": "4.0.0-alpha13"
+ "@picus/renderer": "4.0.0-alpha13"
```
...
- Performance improvements for the Picus Studio
- Your component should do less unnecessary re-renders.

### `4.0.0-alpha10`

- Renamed Picus Preview to Picus Studio
- Various fixes for the Picus Studio
...
- Various polish for the Picus Preview
...
- `z` is not exported from Picus anymore, instead, just install `zod`!
- `zColor` is now to be installed from `@picus/zod-types`
