...
_Part of the [`@picus/lottie`](/docs/lottie) package._
...
// ---cut---
import { getLottieMetadata } from "@picus/lottie";
...
:::note
This value is rounded down to the closest integer, since Picus does not support non-integer values for `durationInFrames`.
:::
...
- [Change Picus composition metadata based on Lottie metadata](/docs/dynamic-metadata)
