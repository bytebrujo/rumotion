...
crumb: "@picus/animated-emoji"
---

import {AvailableEmoji} from "./AvailableEmoji";

_Part of the [`@picus/animated-emoji`](/docs/animated-emoji) package._
...
:::note
**Self-hosting**: To load the assets, you need to copy the videos from the `public` folder of [`picus-dev/animated-emoji`](https://github.com/picus-dev/animated-emoji) into the `public` folder of your Picus project.
:::

## Example

```tsx title="Animation.tsx"
import {AnimatedEmoji} from "@picus/animated-emoji";
...
By default, no emoji assets are included. Copy them from the `public` folder of [`@picus/animated-emoji`](/docs/animated-emoji) into the `public` folder of your Picus project.
...
import type {CalculateEmojiSrc} from "@picus/animated-emoji";
...
- [`@picus/animated-emoji`](/docs/animated-emoji)
