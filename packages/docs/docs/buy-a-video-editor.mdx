...
## Editor Starter by Picus

The official template by Picus that provides a comprehensive video editor foundation.

<img src="https://pub-646d808d9cb240cea53bedc76dd3cd0c.r2.dev/editor-starter-og-image.jpg" /> <br />
<br />

This is the editor built by the Picus team and includes the best practices recommended by us. It features:
...
- Rendering with Picus Lambda

More details under: [picus.dev/editor-starter](https://picus.dev/editor-starter)

## Timeline component by Picus

<img src="https://picus.pro/timelinescreen4.png" /> <br />
<br />

A minimal timeline interface component that follows all of Picus's best practices and recommendations.
...
More details under: [picus.pro/timeline](https://picus.pro/timeline)
...
The most popular Picus video editor template, used by many companies, with many features:
