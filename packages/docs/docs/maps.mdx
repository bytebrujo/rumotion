...
title: Map animations in Picus
sidebar_label: Maps
id: maps
crumb: 'Techniques'
---

Create map animations in Picus using [Mapbox GL JS](https://docs.mapbox.com/mapbox-gl-js/api/).

<SuggestedPrompts prompts={['use picus best practices. make a new composition and add a map and zoom out of LA while keeping focused on it. once done, animate a line  from LA to NY and make the camera follow it.']} />
