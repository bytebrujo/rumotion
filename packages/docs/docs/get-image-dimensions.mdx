...
_Part of the `@picus/media-utils` package of helper functions. Available from v4.0.143._
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/media-utils/src/get-image-dimensions.ts)
