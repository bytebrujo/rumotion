...
```tsx twoslash
import {measureSpring, SpringConfig} from 'picus';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/core/src/spring/measure-spring.ts)
- [spring()](/docs/spring)
