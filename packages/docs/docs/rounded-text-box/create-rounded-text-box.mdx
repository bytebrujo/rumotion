...
crumb: '@picus/rounded-text-box'
---

_Part of the [`@picus/rounded-text-box`](/docs/rounded-text-box) package._
...
[View the source code here.](https://github.com/picus-dev/picus/blob/main/packages/docs/components/demos/RoundedTextBox.tsx)
...
_object_ <TsType type="CreateRoundedTextBoxProps" source="@picus/rounded-text-box" />

Accepts an object with the following properties:

### `textMeasurements`

_array_ <TsType type="Dimensions[]" source="@picus/layout-utils" />
...
_string_ <TsType type="TextAlign" source="@picus/rounded-text-box" />
...
_object_ <TsType type="CreateRoundedTextBoxResult" source="@picus/rounded-text-box" />
...
_object_ <TsType type="BoundingBox" source="@picus/paths" />

The bounding box of the text box. See [`getBoundingBox()`](/docs/paths/get-bounding-box) for the shape.

### `instructions`

_array_ <TsType type="ReducedInstruction[]" source="@picus/paths" />

The SVG path instructions as an array, for use with the [`@picus/paths`](/docs/paths) package.

## See also

- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/rounded-text-box/src/create-rounded-text-box.ts)
- [`@picus/rounded-text-box`](/docs/rounded-text-box)
