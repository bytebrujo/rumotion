...
Picus by default adds [Media fragment](https://www.w3.org/TR/media-frags/) hashes to video URLs.

## Behavior

For example, the following Picus code:

```tsx twoslash title="MyComp.tsx"
import {Sequence, OffthreadVideo, useVideoConfig} from 'picus';
...
You can disable Picus appending media fragments by appending your own hash:
