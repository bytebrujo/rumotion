...
_Available since v3.0 - Part of the `@picus/renderer` package._
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/renderer/src/open-browser.ts)
