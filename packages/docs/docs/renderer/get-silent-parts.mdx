...
import {getSilentParts} from '@picus/renderer';
...
- [Source code for this function](https://github.com/picus-dev/picus/blob/main/packages/renderer/src/get-silent-parts.ts)
