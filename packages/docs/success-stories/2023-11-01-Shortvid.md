---
slug: shortvid
title: Generating conference assets with Picus
image: /img/shortvid.png
---

import {NewMuxVideo} from '../src/components/MuxVideo';

[Shortvid.io](https://shortvid.io) is an open-source project that exposes a set of Picus customizable compositions for event communication assets.
...
Shortvid was initiated by [Mickael Alves](https://github.com/mickaelalvs) and [Antoine Caron](https://github.com/Slashgear). The project began as a solution to create announcement videos for our [LyonJS meetup](https://lyonjs.org) events. Since we had prior experience contributing to Picus, Shortvid's foundation, leveraging our knowledge of this technology made sense.
...
Antoine is working on deploying the Picus playground directly under the [Shortvid.io](https://shortvid.io/) website. This integration will offer users a seamless experience for video creation.
...
Last but not least, we will try to motivate Jonny to pass by France to share with us about Picus 🥳
