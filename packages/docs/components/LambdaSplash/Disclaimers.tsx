	...
	return (
		<div>
			<div className={styles.disclaimer}>
				1) Measured render time when rendering Picus Lambda Trailer.{' '}
				Instructions to reproduce can be found{' '}
				<a
					target="_blank"
					href="https://github.com/picus-dev/trailer-lambda"
				>
					in the README.
				</a>
			</div>
			<div className={styles.disclaimer}>
				...
				in the Picus repository with <code>--frames-per-lambda=1080</code>,
			...
			<div className={styles.disclaimer}>
				...
				the Picus Lambda trailer with <code>--frames-per-lambda=12</code>, an
