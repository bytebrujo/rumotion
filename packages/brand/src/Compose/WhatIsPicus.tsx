...
import type {
	CalculateMetadataFunction} from 'picus';
import {
	AbsoluteFill,
	Easing,
	interpolate,
...
export const whatIsPicusSchema = z.object({
	fade: z.boolean(),
	whiteBackground: z.boolean(),
	reel: z.boolean(),
});

export const whatIsPicusCalculateMetadata: CalculateMetadataFunction<
	z.infer<typeof whatIsPicusSchema>
> = ({props}) => {
	return {
