# Picus AI Video template

<p align="center">
  <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://cdn.webmonch.dev/img/picus-template-promo.png">
      <img alt="Animated Picus Logo" src="https://cdn.webmonch.dev/img/picus-template-promo.png">
    </picture>
</p>
...
Picus is rendering videos based on Timeline (timeline.json in project folder). The timeline is generated by CLI.
...
Picus renderer with template bundle should be deployed as per usual.
...
The source of this template is in the [Picus Monorepo](https://github.com/picus-dev/picus/tree/main/packages/template-ai-video).  
