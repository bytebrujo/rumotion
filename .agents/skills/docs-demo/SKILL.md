---
name: docs-demo
description: Add an interactive demo to the Picus documentation. Use when creating a new <Demo> component for docs pages.
---

# Adding an Interactive Demo to Docs

Interactive demos render a Picus composition inline in documentation pages using `@picus/player`. They live in `packages/docs/components/demos/`.

## Steps

1. **Create a component** in `packages/docs/components/demos/` (e.g. `MyDemo.tsx`). It should be a standard React component using Picus hooks like `useCurrentFrame()` and `useVideoConfig()`.
